...
void setup()
{
    ...
    menu->setDefaultCb(processMenuItem);
    ...
    root.append("sample1", AppMenuItemTag::sample1);
    root.append("sample2", AppMenuItemTag::sample2);

    auto &dev = root.append("dev");

    dev.append("reboot", AppMenuItemTag::dev_reboot);
    dev.append("test1", AppMenuItemTag::dev_test);
}
